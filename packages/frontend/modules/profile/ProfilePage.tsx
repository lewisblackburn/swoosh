...
import {useLogoutMutation, useMeQuery, useUploadAvatarMutation} from '../../generated/graphql';
...
const AvatarUpload: React.FC<AvatarUploadProps> = ({refetch}) => {
	...
	return (
		<div>
			<button onClick={e => handleClick(e)} className="bg-purple-400 text-white px-4 py-1">
				upload avatar
			</button>
