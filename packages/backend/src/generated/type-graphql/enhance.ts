...
const modelsInfo = {
  ...
  Movie: ["id", "title", "description", "locked", "createdAt", "updatedAt"],
...
const outputsInfo = {
  ...
  MovieGroupBy: ["id", "title", "description", "locked", "createdAt", "updatedAt", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  MovieCount: ["actors"],
  MovieCountAggregate: ["id", "title", "description", "locked", "createdAt", "updatedAt", "_all"],
  MovieAvgAggregate: ["id"],
  MovieSumAggregate: ["id"],
  MovieMinAggregate: ["id", "title", "description", "locked", "createdAt", "updatedAt"],
  MovieMaxAggregate: ["id", "title", "description", "locked", "createdAt", "updatedAt"],
  BookCount: ["authors"],
...
const inputsInfo = {
  ...
  MovieWhereInput: ["AND", "OR", "NOT", "id", "title", "description", "locked", "actors", "createdAt", "updatedAt"],
  MovieOrderByWithRelationInput: ["id", "title", "description", "locked", "actors", "createdAt", "updatedAt"],
  MovieWhereUniqueInput: ["id"],
  MovieOrderByWithAggregationInput: ["id", "title", "description", "locked", "createdAt", "updatedAt", "_count", "_avg", "_max", "_min", "_sum"],
  MovieScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "title", "description", "locked", "createdAt", "updatedAt"],
  ...
  MovieCreateInput: ["title", "description", "locked", "createdAt", "updatedAt", "actors"],
  MovieUpdateInput: ["title", "description", "locked", "createdAt", "updatedAt", "actors"],
  MovieCreateManyInput: ["id", "title", "description", "locked", "createdAt", "updatedAt"],
  MovieUpdateManyMutationInput: ["title", "description", "locked", "createdAt", "updatedAt"],
  ...
  MovieCountOrderByAggregateInput: ["id", "title", "description", "locked", "createdAt", "updatedAt"],
  MovieAvgOrderByAggregateInput: ["id"],
  MovieMaxOrderByAggregateInput: ["id", "title", "description", "locked", "createdAt", "updatedAt"],
  MovieMinOrderByAggregateInput: ["id", "title", "description", "locked", "createdAt", "updatedAt"],
  ...
  MovieCreateWithoutActorsInput: ["title", "description", "locked", "createdAt", "updatedAt"],
  ...
  MovieScalarWhereInput: ["AND", "OR", "NOT", "id", "title", "description", "locked", "createdAt", "updatedAt"],
  ...
  MovieUpdateWithoutActorsInput: ["title", "description", "locked", "createdAt", "updatedAt"],
