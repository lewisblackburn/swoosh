...
export class WatchlistMoviesArgs {
  ...
  distinct?: Array<"id" | "title" | "overview" | "thumbnail" | "locked" | "released" | "status" | "runtime" | "revenue" | "trailer" | "createdAt" | "updatedAt"> | undefined;
}
