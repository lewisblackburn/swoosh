...
@TypeGraphQL.InputType("SongReviewLikeOrderByWithRelationInput", {
  isAbstract: true
})
export class SongReviewLikeOrderByWithRelationInput {
  ...
  songReview?: SongReviewOrderByWithRelationInput | undefined;
