...
@TypeGraphQL.InputType("BookReviewLikeOrderByWithRelationInput", {
  isAbstract: true
})
export class BookReviewLikeOrderByWithRelationInput {
  ...
  bookReview?: BookReviewOrderByWithRelationInput | undefined;
