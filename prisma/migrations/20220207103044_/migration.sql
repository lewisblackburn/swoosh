...
CREATE TABLE "ShowLike" (
    ...
    CONSTRAINT "ShowLike_pkey" PRIMARY KEY ("userId","showId")
);
...
-- AddForeignKey
ALTER TABLE "ShowLike" ADD CONSTRAINT "ShowLike_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ShowLike" ADD CONSTRAINT "ShowLike_showId_fkey" FOREIGN KEY ("showId") REFERENCES "Show"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
